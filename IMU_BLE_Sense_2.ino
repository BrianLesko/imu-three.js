...
// This code in Incomplete, a sensor fusion algorithm needs to be implemented to get the correct orientation of the IMU along with a calibration routine for the gyroscope and magnetometer
...
if (IMU.gyroscopeAvailable()) {
  ...
  roll = atan2(E.y, E.z);
  pitch = atan2(-E.x, sqrt(E.y * E.y + E.z * E.z));
  yaw = atan2(N.y, N.x);
  roll = roll * 180.0 / PI;
  ...
  dt = endTime - startTime / 1000.0; // Calculate the time difference
}